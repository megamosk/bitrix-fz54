...
<div class="sale-paysystem-wrapper">
	...
	<form name="ShopForm" action="<?=$params['URL'];?>" method="post">
		...
		<input name="ym_merchant_receipt" value='<?=$params['KASSA']?>' type="hidden" >

		<input name="cps_phone" value="+79266819442" type="hidden"/>
		<input name="cps_email" value="me@megamind.me" type="hidden"/>
